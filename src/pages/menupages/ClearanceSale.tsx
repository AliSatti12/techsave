...
const saleData = [
  ...
  },
  {
    ...
    price: 15,
    image:
      "https://images.unsplash.com/photo-1602143393494-144933902341?q=80&w=800",
  },
];
    ...
    <div className="bg-red-600 min-h-screen py-16 px-6">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-red-100 font-bold tracking-widest uppercase">
            Up to 70% Off — Everything must go!
          </p>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {saleData.map((p) => (
            <div
              key={p.id}
              className="relative group bg-white rounded-[2rem] p-4 shadow-xl"
            >
