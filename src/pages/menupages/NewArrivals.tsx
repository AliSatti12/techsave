...
const newArrivalsData = [
  ...
  {
    id: 2,
    name: "E-Sport Gaming Desk",
    brand: "RAID",
    price: 550,
    image:
      "https://images.unsplash.com/photo-1598550476439-6847785fce6e?q=80&w=800",
  },
  {
    id: 3,
      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex justify-between items-center mb-12">
          <h2 className="text-6xl font-black italic uppercase tracking-tighter text-gray-900">
            The <span className="text-red-600 italic underline">Latest</span>{" "}
            Drop
          </h2>
