        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
          ...
          <div className="lg:col-span-2 space-y-4">
            {cartItems.map((item) => (
              <div
                key={item.id}
                className="bg-white p-4 sm:p-6 rounded-3xl shadow-sm border border-gray-100 flex flex-col sm:flex-row sm:items-center gap-4 sm:gap-6 group transition-all hover:shadow-md"
              >
                {/* Product Info */}
                <div className="flex items-center gap-4 flex-1">
                  {/* Image */}
                  <div className="h-20 w-20 sm:h-24 sm:w-24 flex-shrink-0 overflow-hidden rounded-2xl bg-gray-100">
                    <img
                ...
                <div className="flex items-center justify-between sm:justify-end gap-4">
                  ...
                  <button
                    ...
                    className="p-2 sm:p-3 text-gray-400 hover:text-red-600 transition-colors cursor-pointer"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
