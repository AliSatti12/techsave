      ...
      <div className="bg-gray-900 relative overflow-hidden py-20 text-center">
        ...
        <div className="relative z-10">
          ...
          <p className="text-gray-400 max-w-lg mx-auto">
            Questions or support? We are ready to respond within 24 hours.
          </p>
            ...
            <div className="p-8">
              {submitState === "success" ? (
                <div className="text-center py-10">
                  ...
                  <button
                    onClick={handleReset}
                    className="text-red-600 font-bold flex items-center gap-2 mx-auto border-b-2 border-red-100 hover:border-red-600 transition-all"
                  >
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-1">
                      ...
                      />
                      {errors.name && (
                        <p className="text-red-500 text-[10px] font-bold px-1 uppercase italic">
                          {errors.name.message}
                        </p>
                      )}
                    </div>
                  ...
                  <div className="relative space-y-1">
                    ...
                    >
                      <span
                        className={
                          selectedSubject ? "text-gray-900" : "text-gray-400"
                        }
                      >
