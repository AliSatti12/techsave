    ...
    return (
      <div className="min-h-[70vh] flex flex-col items-center justify-center p-6 bg-white">
        ...
        <p className="text-gray-500 mb-10 text-center max-w-sm leading-relaxed">
          Looks like you haven't discovered anything you love yet. Start exploring our latest tech collection!
        </p>
        <Link 
          to="/" 
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center mb-12 gap-6">
          <div className="text-center md:text-left">
            <span className="text-red-600 font-bold uppercase tracking-[0.3em] text-xs">Personal Collection</span>
            <h1 className="text-5xl font-black text-gray-900 tracking-tighter mt-1">MY WISHLIST</h1>
              ...
              <div className="p-6 pt-0 flex flex-col flex-grow">
                <div className="mb-4">
                   ...
                   <div className="flex items-center gap-2">
                     ...
                     <span className="text-xs text-gray-400 line-through font-medium">${(product.price + 50).toFixed(0)}</span>
                   </div>
                </div>
