  ...
  if (cartItems.length === 0) {
    return (
      <div className="min-h-[70vh] flex flex-col items-center justify-center space-y-6">
        ...
        <Link to="/" className="bg-red-500 text-white px-8 py-3 rounded-xl font-bold hover:bg-black transition-all">
          Shop Now
        </Link>
      </div>
    );
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
          ...
          <div className="lg:col-span-2 space-y-4">
            {cartItems.map((item) => (
              <div key={item.id} className="bg-white p-6 rounded-3xl shadow-sm border border-gray-100 flex items-center gap-6 group transition-all hover:shadow-md">
          ...
          <div className="lg:col-span-1">
            <div className="bg-white p-8 rounded-3xl shadow-xl shadow-gray-200/50 border border-gray-100 sticky top-10">
              ...
              <Link to="/checkout" className="w-full bg-red-500 text-white py-4 rounded-2xl font-bold text-lg hover:bg-black transition-all shadow-lg shadow-red-100 active:scale-95 flex items-center justify-center gap-3 cursor-pointer">
                Checkout Now
              </Link>

              <Link to="/" className="block text-center mt-4 text-sm font-medium text-gray-500 hover:text-red-500 transition-colors">
                Continue Shopping
              </Link>
            </div>
          </div>
