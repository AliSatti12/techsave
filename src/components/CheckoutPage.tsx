            ...
            <div className="bg-white p-8 rounded-3xl border border-gray-100 shadow-sm space-y-5">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div className="space-y-1">
                  ...
                  />
                  {errors.firstName && <span className="text-red-500 text-xs ml-2">{errors.firstName.message}</span>}
                </div>
                ...
                <div className="space-y-1">
                  ...
                  />
                  {errors.lastName && <span className="text-red-500 text-xs ml-2">{errors.lastName.message}</span>}
                </div>
              </div>
              ...
              <div className="space-y-1">
                ...
                />
                {errors.address && <span className="text-red-500 text-xs ml-2">{errors.address.message}</span>}
              </div>
              ...
              <div className="space-y-1">
                ...
                />
                {errors.phone && <span className="text-red-500 text-xs ml-2">{errors.phone.message}</span>}
              </div>
            </div>
